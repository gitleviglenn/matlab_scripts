...
col34(4,:)   = BLACK;  % CNRM         
col34(5,:)   = BLACK;  % DAM         
col34(6,:)   = BLACK;  % ECHAM6         
col34(7,:)   = BLACK;  % FV3         
col34(8,:)   = BLACK;  % GEOS-GCM         
col34(9,:)   = BLACK;  % ICON-GCM
col34(10,:)  = BLACK;  % ICON-LEM-CRM
col34(11,:)  = BLACK;  % ICON-NWP-CRM
col34(12,:)  = BLACK;  % IPSL-CM6
col34(13,:)  = BLACK;  % MESONH
col34(14,:)  = BLACK;  % MPAS
col34(15,:)  = BLACK;  % NICAM
col34(16,:)  = BLACK;  % SAM0-UNICON
col34(17,:)  = BLACK;  % SAM-CRM
col34(18,:)  = BLACK;  % SAM-GCRM
col34(19,:)  = BLACK;  % SCALE
col34(20,:)  = BLACK;  % SP-CAM
col34(21,:)  = BLACK;  % SPX-CAM
col34(22,:)  = BLACK;  % UCLA-CRM
col34(23,:)  = BLACK;  % UKMO-GA7.1
