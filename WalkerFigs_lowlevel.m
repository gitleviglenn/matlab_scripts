...
thick=2;
  ...
  plot(xaxis_gcm2crm,s_enth_25km_noconvlwoff_plot,'--','Color',colyel,'LineWidth',thick)
  ylabel('W m^{-2}')
  xlabel('km')
  ...
  plot(xaxis_gcm2crm,theta_e_gcm_noconvlwoff_plot(:,33),'--','Color',colyel,'LineWidth',thick)
  ylabel('{\rm{\theta_e}} (K)')
  xlabel('km')
  ...
  plot(xaxis_gcm2crm,u_25km_ztmn_noconvlwoff_plot(:,33),'--','Color',colyel,'LineWidth',thick)
...
scale=0.001
  ...
  plot(u_25km_dmn_noconv_plot(10:33),scale*zzfull(10:33),'Color',colyel,'LineWidth',thick)
  plot(u_25km_dmn_noconvlwoff_plot(10:33),scale*zzfull(10:33),'--','Color',colyel,'LineWidth',thick)
  xlabel('mean u (m s^{-1})')
