...
thick=2;
  ...
  hold on
  plot(xcrm_2to1,s_enth_2km_lwoff_plot,'--','Color',colblu,'LineWidth',thick)
  plot(s_enth_1km_plot,'Color',colgrn,'LineWidth',thick)
  plot(s_enth_1km_lwoff_plot,'--','Color',colgrn,'LineWidth',thick)
  plot(xaxis_gcm2crm,s_enth_25km_noconv_plot,'Color',colpur,'LineWidth',thick)
  plot(xaxis_gcm2crm,s_enth_25km_noconvlwoff_plot,'--','Color',colpur,'LineWidth',thick)
  ylabel('W m^{-2}')
  xlabel('km')
  ...
  hold on
  plot(xcrm_2to1,theta_e_2km_lwoff_plot(:,33),'--','Color',colblu,'LineWidth',thick)
  plot(theta_e_1km_plot(:,33),'Color',colgrn,'LineWidth',thick)
  plot(theta_e_1km_lwoff_plot(:,33),'--','Color',colgrn,'LineWidth',thick)
  plot(xaxis_gcm2crm,theta_e_gcm_noconv_plot(:,33),'Color',colpur,'LineWidth',thick)
  plot(xaxis_gcm2crm,theta_e_gcm_noconvlwoff_plot(:,33),'--','Color',colpur,'LineWidth',thick)
  ylabel('{\rm{\theta_e}} (K)')
  xlabel('km')
  title('Low-level {\theta_e}')
 
  subplot(2,2,3)
  plot(u_1km_ztmn_plot(:,33),'Color',colgrn,'LineWidth',thick)
  hold on
  plot(u_1km_ztmn_lwoff_plot(:,33),'--','Color',colgrn,'LineWidth',thick)
  plot(xcrm_2to1,u_2km_ztmn_plot(:,33),'Color',colblu,'LineWidth',thick)
  plot(xcrm_2to1,u_2km_ztmn_lwoff_plot(:,33),'--','Color',colblu,'LineWidth',thick)
  plot(xaxis_gcm2crm,u_25km_ztmn_noconv_plot(:,33),'Color',colpur,'LineWidth',thick)
  plot(xaxis_gcm2crm,u_25km_ztmn_noconvlwoff_plot(:,33),'--','Color',colpur,'LineWidth',thick)
  title('Low-level wind ')
  xlabel('km')
  ylabel('u (m s^{-1})')
scale=0.001
  subplot(2,2,4)
  plot(u_1km_dmn_plot(10:33),scale*zzfull(10:33),'Color',colgrn,'LineWidth',thick)
  hold on
  plot(u_1km_dmn_lwoff_plot(10:33),scale*zzfull(10:33),'--','Color',colgrn,'LineWidth',thick)
  plot(u_2km_dmn_plot(10:33),scale*zzfull(10:33),'Color',colblu,'LineWidth',thick)
  plot(u_2km_dmn_lwoff_plot(10:33),scale*zzfull(10:33),'--','Color',colblu,'LineWidth',thick)
  plot(u_25km_dmn_noconv_plot(10:33),scale*zzfull(10:33),'Color',colpur,'LineWidth',thick)
  plot(u_25km_dmn_noconvlwoff_plot(10:33),scale*zzfull(10:33),'--','Color',colpur,'LineWidth',thick)
  xlabel('mean u (m s^{-1})')
